...
class DeviceControllerTest {
    ...
    void addDeviceTest() throws Exception {
        ...
        DeviceAddReqeustDto deviceAddReqeustDto = new DeviceAddReqeustDto("fcm token example", "android");
        mockMvc.perform(post("/device/device")
                        .header("Authorization","Bearer "+jwt)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(deviceAddReqeustDto)))
    ...
    void check() throws Exception{
        ...
        DeleteDeviceReqeustDto n = new DeleteDeviceReqeustDto("1");
